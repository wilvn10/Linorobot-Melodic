...
#define K_I 2.4 // I constant
#define K_D 0.3 // D constant

//define your robot' specs here
#define MAX_RPM 60               // motor's maximum RPM
#define COUNTS_PER_REV 1400       // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.21       // wheel's diameter in meters
#define PWM_BITS 8                // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.54  // distance between left and right wheels
...
#define MOTOR3_ENCODER_B 31 

#define MOTOR4_ENCODER_A 32
#define MOTOR4_ENCODER_B 33
...
//MOTOR PINS
  ...
  #define MOTOR3_IN_A 34
  #define MOTOR3_IN_B 35
